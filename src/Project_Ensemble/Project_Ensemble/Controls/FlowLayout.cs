...
namespace Project_Ensemble.Controls
{
    ...
    public class FlowLayout : Layout<View>
    {
        public static BindableProperty SpacingProperty =
            BindableProperty.Create("Spacing", typeof(Thickness), typeof(FlowLayout), new Thickness(6));
        ...
        protected override void LayoutChildren(double x, double y, double width, double height)
        {
            ...
            for (var i = 0; i < layoutInfo.Bounds.Count; i++)
            {
        ...
        public class LayoutInfo
        {
            ...
            private List<Rectangle> SizeViews(IList<View> views, double widthConstraint)
            {
                ...
                foreach (var view in views)
                {
                    ...
                    if (viewWidth > widthConstraint) viewWidth = widthConstraint;
            ...
            {
                if (!(_x + viewWidth > widthConstraint)) return;
            ...
            {
                if (viewHeight > _rowHeight) _rowHeight = viewHeight;
            }
        }
    }
}